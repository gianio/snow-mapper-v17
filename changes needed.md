...
### 2.2 Freeze-Thaw Cycle Counting --> Change: "Find a source for such a fomula..
...
### 2.4 Effective Radiation (x Sunshine) --> Change: Find a fomrula that is sufull to callculate the effective radition taking cloudiness into account. 
